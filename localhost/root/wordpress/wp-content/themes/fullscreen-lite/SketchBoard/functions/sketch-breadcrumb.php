...
class fullscreen_lite_breadcrumb_class {

    var $opts;

    function fullscreen_lite_custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '/">' . __('Home', 'fullscreen-lite') . '</a>';
        ...
        $output = $this->fullscreen_lite_simple_breadcrumb_case($post);
    ...
    function fullscreen_lite_simple_breadcrumb_case($der_post) {
        ...
        if (is_page()) {
            ...
            if ($der_post->post_parent) {
                ...
                $this->fullscreen_lite_simple_breadcrumb_case($my_query);
        ...
        if (is_author()) {
            ...
            return __('Author', 'fullscreen-lite') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'fullscreen-lite') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'fullscreen-lite');

        }

		if (is_404()) {            return __('Error 404', 'fullscreen-lite');        }
...
$fullscreen_lite_breadcumb = new fullscreen_lite_breadcrumb_class();
